...
struct ModelingInfo
{
	...
	ball_num = 볼갯수
	*/
	int img_num, focus_num, Rx, Cy, method, location;
	Point2f corners[4];
	Rect ROI;
	double Angle;
	int box_num;
...
enum method_type { HARD_MASKING_MODE, THRESHOLD_MODE, THRESHOLD_INV_MODE, ADAPTHRESHOLD_MODE, ADAPTHRESHOLD_INV_MODE, CANNY_MODE, OTSU_CANNY_MODE, TEMPLETE_MATCHING_MODE,PCA_MODE};

enum DIRECT { BOTTOM = 0, TOP };
enum defect_code {
